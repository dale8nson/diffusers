...
class StableDiffusionXLImg2ImgPipeline(
    ...
    def _get_add_time_ids(
        ...
        if expected_add_embed_dim == (self.unet.config.addition_time_embed_dim * 5 + text_encoder_projection_dim):
            add_time_ids = add_time_ids[:5]
            add_neg_time_ids = add_neg_time_ids[:5]

        passed_add_embed_dim = (
            self.unet.config.addition_time_embed_dim * len(add_time_ids) + text_encoder_projection_dim
        )

        print("addition_time_embed_dim:", self.unet.config.addition_time_embed_dim)
        print("len(add_time_ids):", len(add_time_ids))
